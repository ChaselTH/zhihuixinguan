...
final class BusinessRowPresentation extends PageLayout {
  ...
  private static String stage(RowStage stage){return switch(stage){case READY->"待操作员填报";case BRANCH_REVIEW->"待支行复核 · 只读";case DIVISION_REVIEW->"待分行终审";case RETURNED->"退回待操作员修改";case PUBLISHED->"终审已发布";case LEGACY_PUBLISHED->"";};}
